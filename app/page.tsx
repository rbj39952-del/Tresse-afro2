    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="mb-8">
            <p className="text-xs font-semibold tracking-widest uppercase text-muted mb-1.5">Le·la</p>
            <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight leading-tight mb-3">meilleur·e<br />coiffeur·se afro</h1>
            <p className="text-base text-muted max-w-2xl">près de chez vous, dans toute la France.</p>
          </div>
